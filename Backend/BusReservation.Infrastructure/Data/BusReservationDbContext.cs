...
namespace BusReservation.Infrastructure.Data
{
    public class BusReservationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Route>().HasData(
                new Route { RouteId = 1, Source = "Dhaka", Destination = "Rajshahi", EstimatedDuration = TimeSpan.FromHours(6) },
                new Route { RouteId = 2, Source = "Dhaka", Destination = "Chittagong", EstimatedDuration = TimeSpan.FromHours(7) },
                new Route { RouteId = 3, Source = "Dhaka", Destination = "Cox's Bazar", EstimatedDuration = TimeSpan.FromHours(10) },
                new Route { RouteId = 4, Source = "Dhaka", Destination = "Sylhet", EstimatedDuration = TimeSpan.FromHours(6) },
                new Route { RouteId = 5, Source = "Dhaka", Destination = "Khulna", EstimatedDuration = TimeSpan.FromHours(7) },
                new Route { RouteId = 6, Source = "Dhaka", Destination = "Barisal", EstimatedDuration = TimeSpan.FromHours(6) },
                new Route { RouteId = 7, Source = "Chittagong", Destination = "Cox's Bazar", EstimatedDuration = TimeSpan.FromHours(3) },
                new Route { RouteId = 8, Source = "Chittagong", Destination = "Sylhet", EstimatedDuration = TimeSpan.FromHours(8) }
            );
